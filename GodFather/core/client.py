...
class godfatherClient(TelegramClient):
    def godfather_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**godfatherBot Error report**\n\n"
                        link = "[here](https://t.me/godfatherBot_OP)"
            ...
            if pattern is not None:
                ...
                if edited:
                    godfather.add_event_handler(func, events.MessageEdited(**kwargs))
                godfather.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                godfather.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                godfather.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
godfatherClient.fast_download_file = download_file
godfatherClient.fast_upload_file = upload_file
godfatherClient.reload = restart_script
godfatherClient.get_msg_link = get_message_link
godfatherClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    godfatherClient.send_message = send_message
    godfatherClient.send_file = send_file
    godfatherClient.edit_message = edit_message
