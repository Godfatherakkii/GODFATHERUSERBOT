...
async def fakegs(search, result):
    ...
    font1 = ImageFont.truetype(
        "godfatherbot/helpers/styles/ProductSans-BoldItalic.ttf", 20
    )
    font2 = ImageFont.truetype("godfatherbot/helpers/styles/ProductSans-Light.ttf", 23)
...
async def trumptweet(text):
    ...
    godfather = r.get("message")
    godfatherurl = url(godfather)
    if not godfatherurl:
        return "check syntax once more"
    with open("temp.png", "wb") as f:
        f.write(requests.get(godfather).content)
