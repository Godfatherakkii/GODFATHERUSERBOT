...
@godfather.godfather_cmd(
    ...
    info={
        "header": "To create a private group/channel with GodFather.",
        ...
        "examples": "{tr}create b godfatherUserBot",
    },
)
async def _(event):
    "To create a private group/channel with GodFather"
    type_of_group = event.pattern_match.group(1)
    group_name = event.pattern_match.group(2)
    if type_of_group == "c":
        descript = "This is a Test Channel created using godfatherUserBot"
    else:
        descript = "This is a Test Group created using godfatherUserBot"
    if type_of_group == "g":
        try:
