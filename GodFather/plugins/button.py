...
# button post makker for godfatherUserBot thanks to uniborg for the base
...
from . import eod, godfather, reply_id
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [godfatherUserBot]<buttonurl:https://t.me/GodFather_OP17:same> [support]<buttonurl:https://t.me/GodFather_AI>",
    },
)
async def _(event):
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [GodFather]<buttonurl:https://t.me/GodFather_AI:same> [support]<buttonurl:https://t.me/GodFather_op>",
    },
)
async def _(event):
