...
async def indslogan(event):
    ...
    if x == 2:
        await event.edit(
            "DON'T TRY TO KNOW ABUOT ME I M godfather✌️ @godfatherBoy_XD\nfrom: @godfatherBot_OP"
        )
    if x == 3:
...
async def _(event):
    ...
    if x == 25:
        await event.edit("Written and Created By: @godfather_K_Boy ! thank you🙏🏻❤")
