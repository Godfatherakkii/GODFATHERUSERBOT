...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "usage": "{tr}ss <link>",
        "examples": "{tr}ss https://github.com/ITS-godfatherBOT/godfatherUSERBOT",
    },
)
async def _(event):
    ...
    try:
        ...
        inputstr = input_str
        if cmd == "ss":
            godfatherurl = url(inputstr)
            if not godfatherurl:
                inputstr = "http://" + input_str
                godfatherurl = url(inputstr)
            if not godfatherurl:
                return await godfatherevent.edit("`The given input is not supported url`")
        if cmd == "gis":
            inputstr = f"https://www.google.com/search?q={input_str}"
        driver.get(inputstr)
        await godfatherevent.edit("`Calculating Page Dimensions`")
        ...
        await godfatherevent.edit("`Stoppping Chrome Bin`")
        driver.close()
        ...
        await godfatherevent.edit(f"`{traceback.format_exc()}`")
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}scapture https://github.com/ITS-godfatherBOT/godfatherUSERBOT",
    },
)
async def _(event):
    "To Take a screenshot of a website."
    ...
    if "image" in contentType:
        with io.BytesIO(response_api.content) as screenshot_image:
            ...
            try:
                ...
                await godfatherevent.edit(str(e))
    else:
        await godfatherevent.edit(f"`{response_api.text}`")
