...
# godfatherUserBot module for having some fun with people.
import asyncio
import random
import re
...
from ..helpers.utils import _godfatherutils, parse_pre
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}squirrelsay godfatheruserbot",
            "{tr}milksay godfatherUserBot",
            "{tr}ghostbustersghostbusterssay godfatheruserbot",
        ],
    },
)
...
async def gbun(event):
    ...
    godfatherevent = await eor(event, "**Summoning out le Gungnir ❗️⚜️☠️**")
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1035034432:
            ...
            if len(gbunVar) > 0:
                ...
                jnl += no_reason
            await godfatherevent.edit(jnl)
    else:
        mention = "`Warning!! User 𝙂𝘽𝘼𝙉𝙉𝙀𝘿 By Admin...\nReason: Potential spammer. `"
        await godfatherevent.edit(mention)
