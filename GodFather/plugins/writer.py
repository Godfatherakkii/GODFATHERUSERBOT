...
from . import BOTLOG, BOTLOG_CHATID, godfather, reply_id
...
async def note(e):
    ...
    img = Image.open("GodFather/helpers/resources/extras/template.jpg")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("GodFather/helpers/resources/fonts/assfont.ttf", 30)
    x, y = 150, 140
    lines = text_set(text)
...
async def write_page(event):
    ...
    if not os.path.exists(temp_name):
        urllib.request.urlretrieve(
            f"https://github.com/ITS-godfatherBOT/RESOURCES/raw/master/Notebook/Images/{page}.jpg",
            temp_name,
        )
    if not os.path.exists(font_name):
        urllib.request.urlretrieve(
            f"https://github.com/ITS-godfatherBOT/RESOURCES/blob/master/Notebook/Fonts/{font}.ttf?raw=true",
            font_name,
        )
...
async def notebook_conf(event):
    ...
    urllib.request.urlretrieve(
        f"https://github.com/ITS-godfatherBOT/RESOURCES/raw/master/Notebook/Images/{temp_page}.jpg",
        file,
    )
