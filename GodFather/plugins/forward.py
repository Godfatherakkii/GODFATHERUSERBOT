...
async def all_groups_id(godfather):
    godfathergroups = []
    async for dialog in godfather.client.iter_dialogs():
        entity = dialog.entity
        if isinstance(entity, Channel) and entity.megagroup:
            godfathergroups.append(entity.id)
    return godfathergroups
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "usage": "{tr}fpost <text>",
        "examples": "{tr}fpost godfatherUserBot",
    },
)
async def _(event):
