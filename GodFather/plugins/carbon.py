...
async def carbon_api(event):
    ...
    godfather = await eor(event, "`Carbonizing...\n25%`")
    ...
    driver.get(url)
    await godfather.edit("`Be Patient...\n50%`")
    download_path = "./"
    ...
    await godfather.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await godfather.edit("`Uploading..`")
...
async def carbon_api(event):
    ...
    await godfather.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
    chrome_options.binary_location = Config.CHROME_BIN
...
async def carbon_api(event):
    ...
    await godfather.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await godfather.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
        force_document=True,
...
async def carbon_api(event):
    ...
    await godfather.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await godfather.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await godfather.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await godfather.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await godfather.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await godfather.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await godfather.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await godfather.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
