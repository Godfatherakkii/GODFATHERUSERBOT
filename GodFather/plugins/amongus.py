...
async def amongus_gen(text: str, clr: int) -> str:
    url = "https://github.com/ITS-GodFather/RESOURCES/raw/master/Resources/Amongus/"
    font = ImageFont.truetype(
        BytesIO(
            get(
                "https://github.com/ITS-GodFather/RESOURCES/raw/master/Resources/fonts/bold.ttf"
            ).content
        ),
        60,
    )
...
async def get_imposter_img(text: str) -> str:
    background = get(
        f"https://github.com/ITS-GodFather/RESOURCES/raw/master/Resources/imposter/impostor{randint(1,22)}.png"
    ).content
    font = get(
        "https://github.com/ITS-GodFather/RESOURCES/raw/master/Resources/fonts/roboto_regular.ttf"
    ).content
    font = BytesIO(font)
...
async def imp(event):
    ...
    godfatherevent = await event.reply(f"{name} is ejected.......")
    await asyncio.sleep(2)
    await godfatherevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await godfatherevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
...
async def timp(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    godfatherevent = await eor(event, f"{name} is ejected.......")
    await asyncio.sleep(2)
    await godfatherevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
