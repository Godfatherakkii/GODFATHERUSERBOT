# file summary plugin for godfatherUserBot  by @godfather_K_BOY
import time
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}chatfs @godfatherBot_AI",
    },
)
async def _(event):  # sourcery no-metrics
    ...
    await godfatherevent.edit(result, parse_mode="HTML", link_preview=False)
