...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}str godfatherUserBot",
    },
)
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}zal godfatherUserBot",
    },
)
async def zal(zgfy):
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}cp godfatherUserBot",
    },
)
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}weeb godfatherUserBot",
    },
)
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside godfatherUserBot",
    },
)
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript godfatherUserBot",
    },
)
async def stylish_generator(event):
...
@godfather.godfather_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript godfatherUserBot",
    },
)
async def stylish_generator(event):
