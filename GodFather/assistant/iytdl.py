...
PATH = "./GodFather/cache/ytsearch.json"
menu_category = "bot"
...
async def iytdl_inline(event):
    ...
    godfatherevent = await eor(event, f"🔎 Searching Youtube for: `'{input_url}'`")
    type = True
    cout = 0
    results = None
    while type:
    ...
    if results:
        ...
        await godfatherevent.edit("`Sorry!. Can't find any results`")
